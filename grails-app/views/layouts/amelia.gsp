		...
		<div class="row bs-docs-section body-bottom-padding">
			<div class="col-lg-4">
				<div class="jumbotron-custom">
						...
						<p>
							Using a custom designed landmarking and meta-learning algorithms Winston is capable of providing you good quality results in almost no time. 
							This saves your time and helps you to analyze data more precisely.
						</p>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="jumbotron-custom">
						...
						<p>
							Winston allows you to upload, visualize and analyze your data online.
							Basically you don't need any knowledge of neither data mining methods nor programming. 
			...
			<div class="col-lg-4">
				<div class="jumbotron-custom">
						...
						<p>
							Your data are processed on a high-performance computational cluster which is capable of executing many tasks at the same time.
							This is useful when you want to achieve best results possible. 
						</p>
				</div>
			</div>
		</div>
